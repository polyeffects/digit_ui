...
effect_prototypes_models = {"digit": {
        "input": {"inputs": {},
 ...
 'tempo_ratio': {'description': '',
    ...
    'algo_reverb': {'controls': {'blend_param': ['blend', 0.5, 0.0, 1.0],
                              'density_param': ['decay', 0.5, 0.0, 1.0],
                              ...
                              'spread_param': ['diffusion', 0.5, 0.0, 1.0],
                              'texture_param': ['damp', 0.5, 0.0, 1.0]},
 ...
 'bitmangle': {'controls': {'bits': ['bits', 0.0, 0.0, 8.0],
               ...
               'outputs': {'aux': ['aux', 'AudioPort'],
                           'out': ['out', 'AudioPort']}},
 'looping_delay': {'controls': {'blend_param': ['blend', 0.5, 0.0, 1.0],
                                'density_param': ['diffusion', 0.5, 0.0, 1.0],
                                'feedback_param': ['feedback', 0.5, 0.0, 1.0],
                                'freeze_param': ['freeze', 0.5, 0.0, 1.0],
                                'in_gain_param': ['in_gain', 0.5, 0.0, 1.0],
                                'pitch_param': ['pitch', 0.0, -48.0, 48.0],
                                'position_param': ['loop start', 0.5, 0.0, 1.0],
                                'reverb_param': ['reverb', 0.5, 0.0, 1.0],
                                'reverse_param': ['reverse', 0.5, 0.0, 1.0],
                                'size_param': ['loop length', 0.5, 0.0, 1.0],
                   ...
                   'outputs': {'l_out': ['L Out', 'AudioPort'],
                               'r_out': ['R Out', 'AudioPort']}},
 'time_stretch': {'controls': {'blend_param': ['blend', 0.5, 0.0, 1.0],
                               'density_param': ['Diffusion', 0.5, 0.0, 1.0],
                               'feedback_param': ['feedback', 0.5, 0.0, 1.0],
                               'freeze_param': ['freeze', 0.5, 0.0, 1.0],
                               'in_gain_param': ['in_gain', 0.5, 0.0, 1.0],
                  ...
                  'outputs': {'l_out': ['L Out', 'AudioPort'],
                              'r_out': ['R Out', 'AudioPort']}},
 'twist_delay': {'controls': {'dry_wet': ['dry wet', 1.0, 0.0, 1.0],
                              'feedback': ['feedback', 1.0, 0.0, 1.0],
                              'length': ['length', 0.5, 0.0, 1.0],
 ...
 #############
    ...
    'control_to_midi': {'description': '',
        'controls': {'AUTOFF': ['Auto Note-Off', 0, 0, 1],
                         ...
                         'inputs': {},
                         'outputs': {'MIDI_OUT': ['MIDI Out', ':AtomPort']}},
     'delay': {'description': '','controls': {'Amp_5': ['Level', 0.5, 0, 1],
                      'BPM_0': ['BPM', 120, 30, 300],
                      'DelayT60_3': ['Glide', 0.5, 0, 100],
                      'Delay_1': ['Time', 0.5, 0.001, 64],
                      'FeedbackSm_6': ['Tone', 0, 0, 1],
         ...
         'inputs': {'Amp_5': ['Amp', 'CVPort'],
                    ...
                    'in0': ['in', 'AudioPort']},
         'outputs': {'out0': ['out', 'AudioPort']}},
     'env_follower': {'description': '','controls': {'ATIME': ['Attack Time', 0.01, 0.001, 15.0],
                                   'CDIRECTION': ['Invert', 0, 0, 1],
                                   'CMAXV': ['Maximum Value',
                                             1.0,
                                             0.0,
                      ...
                      'outputs': {#'CTL_IN': ['Input Level', 'ControlPort'],
                                  #'CTL_OUT': ['Control Out', 'ControlPort'],
                                  'CV_OUT': ['CV Out', 'CVPort']}},
     'filter': {'description': '','controls': {'exp_fm_gain': ['Exp. FM gain', 0.5, 0.0, 10.0],
                ...
                'inputs': {'exp_fm': ['Exp FM', 'CVPort'],
                           ...
                           'res_mod': ['Resonance Mod', 'CVPort']},
                'outputs': {'out': ['Output', 'AudioPort']}},
     'foot_switch_a': {'description': '','controls': {'bpm': ['BPM', 120.0, 35.0, 350.0],
                          'latching': ['Is Latching', 0.0, 0.0, 1.0],
                          'on_v': ['On Value', 1.0, -1.0, 100.0],
                          'off_v': ['Off Value', 0.0, -1.0, 100.0],
                          'value': ['value', 0.0, 0.0, 1.0]},
     ...
     'foot_switch_b': {'description': '','controls': {'bpm': ['BPM', 120.0, 35.0, 350.0],
                          'latching': ['Is Latching', 0.0, 0.0, 1.0],
                          'on_v': ['On Value', 1.0, -1.0, 100.0],
                          'off_v': ['Off Value', 0.0, -1.0, 100.0],
                          'value': ['value', 0.0, 0.0, 1.0]},
                         ...
                         'outputs': {'bpm_out': ['BPM Out', 'ControlPort'],
                                     'out': ['Value Out', 'CVPort']}},
     'foot_switch_c': {'description': '','controls': {'bpm': ['BPM', 120.0, 35.0, 350.0],
                          'latching': ['Is Latching', 0.0, 0.0, 1.0],
                          'on_v': ['On Value', 1.0, -1.0, 100.0],
                          'off_v': ['Off Value', 0.0, -1.0, 100.0],
                          'value': ['value', 0.0, 0.0, 1.0]},
                         ...
                         'outputs': {'bpm_out': ['BPM Out', 'ControlPort'],
                                     'out': ['Value Out', 'CVPort']}},
     'lfo': {'description': '','controls': {'phi0': ['Shape Mod', 0, 0.0, 6.28],
                          'tempo': ['Tempo', 120.0, 1.0, 320.0],
                          'tempoMultiplier': ['Tempo Multiplier',
                                              1.0,
                                              0.0078125,
             ...
             'outputs': {'output': ['Output', 'CVPort']}},
     'mix_vca': {'description': '','controls': {'gain1': ['Gain Offset', 0, 0, 1],
                              'gain1Data': ['Main Gain', 0.0, -1.0, 1.0],
                              'gain2': ['2nd Gain Boost', 0, 0, 1],
                              'gain2Data': ['2nd Gain', 0.0, -1.0, 1.0],
                              'in1': ['In 1 Level', 1, 0, 2],
                 ...
                 'inputs': {'gain1Data': ['Main Gain', 'CVPort'],
                            ...
                            'in2Data': ['In 2', 'AudioPort']},
                 'outputs': {'out': ['Out', 'AudioPort']}},
     'mono_EQ': {'description': '','controls': {'HPQ': ['HighPass Resonance', 0.7, 0.0, 1.4],
                              'HPfreq': ['Highpass Frequency', 20.0, 5.0, 1250.0],
                              'HSfreq': ['Highshelf Frequency',
                                         8000.0,
                                         1000.0,
                 ...
                 'inputs': {'in': ['In', 'AudioPort']},
                 'outputs': { 'out': ['Out', 'AudioPort']}},
     'pan': {'description': '','controls': {'panCV': ['Pan CV', 0.0, -1.0, 1.0],
                          'panGain': ['Pan Gain', 0, 0, 2],
                          'panOffset': ['Pan Offset', 0, -1, 1],
                          'panningMode': ['Panning Mode', 0, 0, 4]},
             'inputs': {'in': ['In', 'AudioPort'], 'panCV': ['Pan CV', 'CVPort']},
             'outputs': {'out1': ['Out L', 'AudioPort'],
                         'out2': ['Out R', 'AudioPort']}},
     'reverse': {'description': '','controls': {'dry': ['Dry Level', 0.0, -90.0, 20.0],
                              'fragment': ['Fragment Length',
                                           1000.0,
                                           100.0,
                                           1600.0],
                 ...
                 'inputs': {'dry': ['Dry Level', 'CVPort'],
                            ...
                            'wet': ['Wet Level', 'CVPort']},
                 'outputs': {'output': ['Output', 'AudioPort']}},
     'saturator': {'description': '','controls': {'Postgain': ['Postgain', 0, -90, 20],
                                'Pregain': ['Pregain', 0, -90, 20]},
                   'inputs': {'Input': ['Input', 'AudioPort'],
                              'Postgain': ['Postgain', 'CVPort'],
                              'Pregain': ['Pregain', 'CVPort']},
                   'outputs': {'Output': ['Output', 'AudioPort']}},
     'slew_limiter': {'description': '','controls': {'in': ['In', 0.0, -1.0, 1.0],
                                   'timeDown': ['Time Down', 0.5, 0, 10],
                                   'timeUp': ['Time Up', 0.5, 0.0, 10]},
                      'inputs': {'in': ['In', 'CVPort']},
                      'outputs': {'out': ['Out', 'CVPort']}},
     'square_distortion': {'description': '','controls': {'DOWN': ['Down', 0.02, -0.5, 1.0],
                                        'IN_GAIN': ['Input Gain', 1.0, 0.0, 1.0],
                                        'OCTAVE': ['Octave', 0, -2, 1.0],
                                        'OUT_GAIN': ['Output Gain', 1.0, 0.0, 1.0],
                                        'UP': ['Up', 0.02, -0.5, 1.0],
                           ...
                           'inputs': {'INPUT': ['Audio In', 'AudioPort']},
                           'outputs': {'OUTPUT': ['Audio Out', 'AudioPort']}},
     'stereo_EQ': {'description': '','controls': {'HPQ': ['HighPass Resonance', 0.7, 0.0, 1.4],
                                'HPfreq': ['Highpass Frequency', 20.0, 5.0, 1250.0],
                                'HSfreq': ['Highshelf Frequency',
                                           8000.0,
                                           1000.0,
                   ...
                   'outputs': {'outL': ['Out Left', 'AudioPort'],
                               'outR': ['Out Right', 'AudioPort']}},
     'warmth': {'description': '','controls': {'blend': ['Tape--Tube Blend', 10, -10, 10],
                             'drive': ['Drive', 5.0, 0.1, 10]},
                'inputs': {'blend': ['Tape--Tube Blend', 'CVPort'],
                           'drive': ['Drive', 'CVPort'],
                           'input': ['Input', 'AudioPort']},
                'outputs': {'output': ['Output', 'AudioPort']}},
     'auto_swell': {'description': '','controls': {'DOWNTIME': ['DOWNTIME', 5.0, 0.0, 1000],
                                 'TRESHOLD': ['THRESHOLD', 1.0, 0.0, 1],
                                 'UPTIME': ['UPTIME', 100, 0.0, 1000]},
                    'inputs': {'TRESHOLD': ['THRESHOLD', 'CVPort'],
                               'in': ['In', 'AudioPort']},
                    'outputs': {'out': ['Out', 'AudioPort']}},
     'freeze': {'description': '','controls': {'DRONE_GAIN': ['Drone Gain', 0.5, 0.0, 2.0],
                             'RELEASE': ['Release', 0.5, 0.01, 3.0],
                             'STICK_IT': ['Freeze', 0, 0, 1]},
                'inputs': {'INPUT': ['Audio In', 'AudioPort'],
                           'STICK_IT': ['Freeze', 'CVPort']},
                'outputs': {'OUTPUT': ['Audio Out', 'AudioPort']}},
     'turntable_stop': {'description': '','controls': {'DCURVE': ['Decay Curve', 0.0, -10.0, 10.0],
                                     'DTIME': ['Decay Time', 0.5, 0.01, 10.0],
                                     'PULL_THE_PLUG': ['Pull the Plug', 0, 0, 1]},
                        'inputs': {'DTIME': ['Decay Time', 'CVPort'],
                                   'INPUT': ['Audio In', 'AudioPort'],
                                   'PULL_THE_PLUG': ['Pull the Plug', 'CVPort']},
                        'outputs': {'OUTPUT': ['Audio Out', 'AudioPort']}},
     'whammy': {'description': '','controls': {'EXPRESSION': ['Expression', 0.0, 0.0, 1.0],
                             'FINISH': ['Finish', 12, -36, 24],
                             'LOCK': ['Lock Mode', 1, 0, 2],
                             'MODE': ['Mode', 0, 0, 2],
                             'START': ['Start', 0, -36, 24]},
 ...
 'stereo_compressor': {'description': '','controls': {'Ratio': ['Ratio', 0.0, 0.0, 1.0],
                       ...
                       'outputs': {'outL': ['Out Left', 'AudioPort'],
                                   'outR': ['Out Right', 'AudioPort']}},
    'attenuverter': {'description': '','controls': {'multiplicand': ['Multiplicand', 0.5, -1.0, 1.0],
                               'multiplier': ['Multiplier', 0.5, -1.0, 1.0]},
                  'inputs': {'multiplicand': ['Multiplicand', 'CVPort'],
                           'multiplier': ['Multiplier', 'CVPort']},
                  'outputs': {'product': ['Product', 'CVPort']}},
 'tempo_ratio': {'description': '','controls': {'denominator': ['Divider', 0.5, 0.1, 16.0],
                              'numerator': ['Tempo', 120.0, 5.0, 300.0]},
                       'inputs': {'denominator': ['Tempo', 'ControlPort']},
                 'outputs': {'ratio': ['Ratio', 'ControlPort']}},
 ...
 'bitmangle': {'controls': {'bits': ['bits', 0.0, 0.0, 8.0],
               ...
               'outputs': {'aux': ['aux', 'AudioPort'],
                           'out': ['out', 'AudioPort']}},
 'chebyschev_waveshaper': {'controls': {'gain': ['gain', 0.5, 0.0, 1.0],
                           ...
                           'outputs': {'aux': ['aux', 'AudioPort'],
                                       'out': ['out', 'AudioPort']}},
 'comparator': {'controls': {'comparator': ['comparator', 0.0, 0.0, 8.0],
                             'input_amp': ['amp or freq', 1.0, 0.0, 1.0],
                             'input_amp_2': ['input amplitude 2',
                                             1.0,
                                             0.0,
                ...
                'outputs': {'aux': ['aux', 'AudioPort'],
                            'out': ['out', 'AudioPort']}},
 'doppler_panner': {'controls': {'lfo_amplitude': ['lfo_amplitude',
                                                   1.0,
                                                   0.0,
                                                   1.0],
                                 'lfo_frequency': ['lfo_frequency',
                                                   ...
                                                   0.0,
                                                   1.0],
                                 'space_size': ['space_size', 0.0, 0.0, 3.0],
                                 'x_coord': ['x_coord', 0.0, 0.0, 8.0],
                                 'y_coord': ['y_coord', 0.5, 0.0, 1.0]},
                    'inputs': {'carrier': ['carrier', 'AudioPort'],
                               ...
                               'lfo_frequency_cv': ['lfo frequency cv',
                                                    'CVPort'],
                               'modulator': ['modulator', 'AudioPort'],
                               'x_coord_cv': ['x_coord_cv', 'CVPort'],
                               'y_coord_cv': ['y_coord_cv', 'CVPort']},
                    'outputs': {'aux': ['aux', 'AudioPort'],
                                'out': ['out', 'AudioPort']}},
 'frequency_shifter': {'controls': {'crossfade': ['crossfade', 0.5, 0.0, 1.0],
                       ...
                       'outputs': {'aux': ['aux', 'AudioPort'],
                                   'out': ['out', 'AudioPort']}},
 'granular': {'controls': {'blend_param': ['blend', 0.5, 0.0, 1.0],
 ...
 'looping_delay': {'controls': {'blend_param': ['blend', 0.5, 0.0, 1.0],
                   ...
                   'outputs': {'l_out': ['L Out', 'AudioPort'],
                               'r_out': ['R Out', 'AudioPort']}},
 'meta_modulation': {'controls': {'algorithm': ['algorithm', 0.0, 0.0, 8.0],
                     ...
                     'outputs': {'aux': ['aux', 'AudioPort'],
                                 'out': ['out', 'AudioPort']}},
 'resonestor': {'controls': {'blend_param': ['random mod', 0.5, 0.0, 1.0],
                             'density_param': ['decay', 0.5, 0.0, 1.0],
                             'feedback_param': ['harmonics', 0.5, 0.0, 1.0],
                             'freeze_param': ['Switch Voice', 0.5, 0.0, 1.0],
                             'in_gain_param': ['in_gain', 0.5, 0.0, 1.0],
                             'pitch_param': ['pitch', 0.0, -48.0, 48.0],
                             'position_param': ['timbre', 0.5, 0.0, 1.0],
                             'reverb_param': ['scatter', 0.5, 0.0, 1.0],
                             'reverse_param': ['reverse', 0.5, 0.0, 1.0],
                             'size_param': ['chord', 0.5, 0.0, 1.0],
                             'spread_param': ['spread', 0.5, 0.0, 1.0],
                             'texture_param': ['filter', 0.5, 0.0, 1.0]},
                ...
                'outputs': {'l_out': ['L Out', 'AudioPort'],
                            'r_out': ['R Out', 'AudioPort']}},
 'spectral_twist': {'controls': {'blend_param': ['blend', 0.5, 0.0, 1.0],
                                 'density_param': ['density', 0.5, 0.0, 1.0],
                                 'feedback_param': ['feedback', 0.5, 0.0, 1.0],
                                 'freeze_param': ['freeze', 0.5, 0.0, 1.0],
                                 'in_gain_param': ['in_gain', 0.5, 0.0, 1.0],
 ...
 'twist_delay': {'controls': {'dry_wet': ['dry wet', 1.0, 0.0, 1.0],
                 ...
                 'outputs': {'aux': ['aux', 'AudioPort'],
                             'out': ['out', 'AudioPort']}},
 'vocoder': {'controls': {'input_amp': ['amp or freq', 1.0, 0.0, 1.0],
                          'input_amp_2': ['input amplitude 2', 1.0, 0.0, 1.0],
                          'int_osc': ['int_osc', 0.0, 0.0, 3.0],
             ...
             'outputs': {'aux': ['aux', 'AudioPort'],
                         'out': ['out', 'AudioPort']}},
 'wavefolder': {'controls': {'input_amp': ['amp or freq', 1.0, 0.0, 1.0],
                             'input_amp_2': ['input amplitude 2',
                                             1.0,
                                             0.0,
                                             1.0],
