...
effect_prototypes_models = {"digit": {
    ...
    'amp_bass_svt40': {'controls': {'BASS': ['BASS', 0.5, 0.0, 1.0],
     ...
     'whammy': {'controls': {'EXPRESSION': ['Expression', 0.0, 0.0, 1.0],
                ...
                'inputs': {'EXPRESSION': ['Expression', 'CVPort'],
                           ...
                           'START': ['Start', 'CVPort']},
                'outputs': { 'OUTPUT': ['Audio Out', 'AudioPort']}},
    'attenuverter': {'controls': {'multiplicand': ['Multiplicand', 0.5, -1.0, 1.0],
    ...
    'tempo_ratio': {'controls': {'denominator': ['Denominator', 0.5, 0.1, 16.0],
                              'numerator': ['Numerator', 120.0, 5.0, 300.0]},
                       'inputs': {'denominator': ['Denominator', 'AudioPort'],
                                  'numerator': ['Numerator', 'AudioPort']},
 ...
 'stereo_compressor': {'controls': {'Ratio': ['Ratio', 0.0, 0.0, 1.0],
    ...
    'attenuverter': {'controls': {'multiplicand': ['Multiplicand', 0.5, -1.0, 1.0],
                  ...
                  'inputs': {'multiplicand': ['Multiplicand', 'CVPort'],
                           'multiplier': ['Multiplier', 'CVPort']},
                  'outputs': {'product': ['Product', 'CVPort']}},
 'tempo_ratio': {'controls': {'denominator': ['Divider', 0.5, 0.1, 16.0],
