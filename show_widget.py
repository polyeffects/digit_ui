...
effect_prototypes = {
        ...
        "output": {"inputs": {"input": ["out", "AudioPort"]},
            "outputs": {},
            "controls": {}},
    'control_to_midi': {'controls': {'AUTOFF': ['Auto Note-Off', 0, 0, 1.0],
                                      'CHAN': ['Channel', 0, 0, 1.0],
                                      'DATA1': ['Note/CC/PG Number', 0, 0, 1.0],
                                      'DATA2': ['Value', 0, 0, 1.0],
                                      'DELAY': ['1st Msg Repeat Delay Time',
                                                0.0,
                                                0.0,
                                                1.0],
                                      'ENABLE': ['Enable', 1, 0, 1.0],
                                      'MSGTYPE': ['Message Type', 11, 8, 1.0]},
                         'inputs': {},
     ...
     'env_follower': {'controls': {'ATIME': ['Attack Time', 0.01, 0.001, 1.0],
                                   'CDIRECTION': ['Invert', 0, 0, 1.0],
                                   'CMAXV': ['Maximum Value',
                                             1.0,
                                             0.0,
                                             1.0],
                                   'CMINV': ['Minimum Value',
                                             ...
                                             0.0,
                                             1.0],
                                   'DTIME': ['Decay Time', 1.0, 0.001, 1.0],
                                   'PEAKRMS': ['Peak/RMS', 0.0, 0.0, 1.0],
                                   'SATURATION': ['Saturation', 1.0, 0.0, 1.0],
     ...
     'filter': {'controls': {'exp_fm': ['Exp FM', 0.5, 0.0, 1.0],
                             'exp_fm_gain': ['Exp. FM gain', 0.5, 0.0, 1.0],
                             'fm': ['FM', 0.5, 0.0, 1.0],
                             'freq': ['Frequency', 440.0, 1e-06, 1.0],
                             'in_gain': ['Input gain', 0.0, -60.0, 1.0],
                             'out_gain': ['Output gain', 0.0, -15.0, 1.0],
                             'res': ['Resonance', 0.5, 0.0, 1.0],
                             'res_gain': ['Resonance gain', 0.5, 0.0, 1.0],
                             'res_mod': ['Resonance Mod', 0.5, 0.0, 1.0]},
     ...
     'foot_switch_c': {'controls': {'in': ['Control Input', 0.5, 0.0, 1.0]},
                       'inputs': {},
                       'outputs': {'out': ['Out', 'CVPort']}},
     'lfo': {'controls': {'phi0': ['Phi0', 0, 0.0, 1.0],
                          'reset': ['Reset', 0.0, -1.0, 1.0],
                          'tempo': ['Tempo', 120.0, 1.0, 1.0],
                          'tempoMultiplier': ['Tempo Multiplier',
                                              1.0,
                                              0.0078125,
                                              1.0],
                          'waveForm': ['Wave Form', 0, 0, 1.0]},
             'inputs': {'reset': ['Reset', 'CVPort']},
             'outputs': {'output': ['Output', 'CVPort']}},
     'mix_vca': {'controls': {'gain1': ['Gain Offset', 0, 0, 1.0],
                              'gain1Data': ['Main Gain', 0.0, -1.0, 1.0],
                              'gain2': ['2nd Gain Boost', 0, 0, 1.0],
                              'gain2Data': ['2nd Gain', 0.0, -1.0, 1.0],
                              'in1': ['In 1 Level', 1, 0, 1.0],
                              'in2': ['In 2 Level', 1, 0, 1.0],
                              'outputLevel': ['Output Level', 1, 0, 1.0]},
     ...
     'mono_EQ': {'controls': {'HPQ': ['HighPass Resonance', 0.7, 0.0, 1.0],
                              'HPfreq': ['Highpass Frequency', 20.0, 5.0, 1.0],
                              'HSfreq': ['Highshelf Frequency',
                                         8000.0,
                                         1000.0,
                                         1.0],
                              'HSgain': ['Highshelf Gain', 0.0, -18.0, 1.0],
                              'HSq': ['Highshelf Bandwidth', 1.0, 0.0625, 1.0],
                              'HSsec': ['Highshelf', 1, 0, 1.0],
                              'HighPass': ['Highpass', 0, 0, 1.0],
                              'LPQ': ['LowPass Resonance', 1.0, 0.0, 1.0],
                              'LPfreq': ['Lowpass Frequency', 20000.0, 500.0, 1.0],
                              'LSfreq': ['Lowshelf Frequency', 80.0, 25.0, 1.0],
                              'LSgain': ['Lowshelf Gain', 0.0, -18.0, 1.0],
                              'LSq': ['Lowshelf Bandwidth', 1.0, 0.0625, 1.0],
                              'LSsec': ['Lowshelf', 1, 0, 1.0],
                              'LowPass': ['Lowpass', 0, 0, 1.0],
                              'enable': ['Enable', 1, 0, 1.0],
                              'freq1': ['Frequency 1', 160.0, 20.0, 1.0],
                              'freq2': ['Frequency 2', 397.0, 40.0, 1.0],
                              'freq3': ['Frequency 3', 1250.0, 100.0, 1.0],
                              'freq4': ['Frequency 4', 2500.0, 200.0, 1.0],
                              'gain': ['Gain', 0.0, -18.0, 1.0],
                              'gain1': ['Gain 1', 0.0, -18.0, 1.0],
                              'gain2': ['Gain 2', 0.0, -18.0, 1.0],
                              'gain3': ['Gain 3', 0.0, -18.0, 1.0],
                              'gain4': ['Gain 4', 0.0, -18.0, 1.0],
                              'q1': ['Bandwidth 1', 0.6, 0.0625, 1.0],
                              'q2': ['Bandwidth 2', 0.6, 0.0625, 1.0],
                              'q3': ['Bandwidth 3', 0.6, 0.0625, 1.0],
                              'q4': ['Bandwidth 4', 0.6, 0.0625, 1.0],
                              'sec1': ['Section 1', 1, 0, 1.0],
                              'sec2': ['Section 2', 1, 0, 1.0],
                              'sec3': ['Section 3', 1, 0, 1.0],
                              'sec4': ['Section 4', 1, 0, 1.0]},
                 'inputs': {'in': ['In', 'AudioPort'],
                            'inL': ['In Left', 'AudioPort'],
                            'inR': ['In Right', 'AudioPort']},
                 'outputs': {'notify': ['Notify', ':AtomPort'],
                             'out': ['Out', 'AudioPort'],
                             'outL': ['Out Left', 'AudioPort'],
                             'outR': ['Out Right', 'AudioPort'],
                             'peak': ['Peak', 'ControlPort']}},
     'mono_cab': {'controls': {'gain': ['Output Gain', 0.0, -24.0, 1.0],
                  ...
                  'outputs': {'notify': ['Notify', ':AtomPort'],
                              'out': ['Out', 'AudioPort'],
                              'out_1': ['OutL', 'AudioPort'],
                              'out_2': ['OutR', 'AudioPort']}},
     'mono_reverb': {'controls': {'gain': ['Output Gain', 0.0, -24.0, 1.0],
                                 "ir": ["/audio/reverbs/emt_140_dark_1.wav", 0, 0, 1]},
                     'inputs': {'gain': ['Output Gain', 'CVPort'],
                                'in': ['In', 'AudioPort'],
                                'in_1': ['InL', 'AudioPort'],
                                'in_2': ['InR', 'AudioPort']},
                     'outputs': {'latency': ['Signal Latency', 'ControlPort'],
                                 'out': ['Out', 'AudioPort'],
                                 'out_1': ['OutL', 'AudioPort'],
                                 'out_2': ['OutR', 'AudioPort']}},
     'pan': {'controls': {'panCV': ['Pan CV', 0.0, -1.0, 1.0],
                          'panGain': ['Pan Gain', 0, 0, 1.0],
                          'panOffset': ['Pan Offset', 0, -1, 1.0],
                          'panningMode': ['Panning Mode', 0, 0, 1.0]},
             'inputs': {'in': ['In', 'AudioPort'], 'panCV': ['Pan CV', 'CVPort']},
             'outputs': {'out1': ['Out L', 'AudioPort'],
                         'out2': ['Out R', 'AudioPort']}},
     'reverse': {'controls': {'dry': ['Dry Level', 0.0, -90.0, 1.0],
                              'fragment': ['Fragment Length', 1000.0, 100.0, 1.0],
                              'wet': ['Wet Level', 0.0, -90.0, 1.0]},
                 'inputs': {'dry': ['Dry Level', 'CVPort'],
                            'input': ['Input', 'AudioPort'],
                            'wet': ['Wet Level', 'CVPort']},
                 'outputs': {'output': ['Output', 'AudioPort']}},
     'saturator': {'controls': {'Postgain': ['Postgain', 0, -90, 1.0],
                                'Pregain': ['Pregain', 0, -90, 1.0]},
                   'inputs': {'Input': ['Input', 'AudioPort'],
                              'Postgain': ['Postgain', 'CVPort'],
                              'Pregain': ['Pregain', 'CVPort']},
                   'outputs': {'Output': ['Output', 'AudioPort']}},
     'slew_limiter': {'controls': {'in': ['In', 0.0, -1.0, 1.0],
                                   'timeDown': ['Time Down', 0.5, 0, 1.0],
                                   'timeUp': ['Time Up', 0.5, 0.0, 1.0]},
                      'inputs': {'in': ['In', 'CVPort']},
                      'outputs': {'out': ['Out', 'CVPort']}},
     ...
     'stereo_EQ': {'controls': {'HPQ': ['HighPass Resonance', 0.7, 0.0, 1.0],
                                'HPfreq': ['Highpass Frequency', 20.0, 5.0, 1.0],
                                'HSfreq': ['Highshelf Frequency',
                                           8000.0,
                                           1000.0,
                   ...
                   'outputs': {'notify': ['Notify', ':AtomPort'],
                               ...
                               'outR': ['Out Right', 'AudioPort'],
                               'peak': ['Peak', 'ControlPort']}},
     'stereo_cab': {'controls': {'gain': ['Output Gain', 0.0, -24.0, 1.0],
                            "ir": ["/audio/cabs/1x12cab.wav", 0, 0, 1]},
                    'inputs': {'gain': ['Output Gain', 'CVPort'],
                               'in': ['In', 'AudioPort'],
                               'in_1': ['InL', 'AudioPort'],
                    ...
                    'outputs': {'notify': ['Notify', ':AtomPort'],
                                ...
                                'out_1': ['OutL', 'AudioPort'],
                                'out_2': ['OutR', 'AudioPort']}},
     'stereo_reverb': {'controls': {'gain': ['Output Gain', 0.0, -24.0, 1.0],
                                 "ir": ["/audio/reverbs/emt_140_dark_1.wav", 0, 0, 1]},
                       'inputs': {'gain': ['Output Gain', 'CVPort'],
                                  'in': ['In', 'AudioPort'],
                                  'in_1': ['InL', 'AudioPort'],
                       ...
                       'outputs': {'latency': ['Signal Latency', 'ControlPort'],
                                   ...
                                   'out_1': ['OutL', 'AudioPort'],
                                   'out_2': ['OutR', 'AudioPort']}},
     'true_stereo_cab': {'controls': {'gain': ['Gain', 0.0, -24.0, 1.0],
                            "ir": ["/audio/cabs/1x12cab.wav", 0, 0, 1]},
                         ...
                         'outputs': {'notify': ['Notify', ':AtomPort'],
                                     ...
                                     'out_1': ['OutL', 'AudioPort'],
                                     'out_2': ['OutR', 'AudioPort']}},
     'true_stereo_reverb': {'controls': {'gain': ['Output Gain', 0.0, -24.0, 1.0],
                                 "ir": ["/audio/reverbs/emt_140_dark_1.wav", 0, 0, 1]},
                            'inputs': {'gain': ['Output Gain', 'CVPort'],
                                       'in': ['In', 'AudioPort'],
                                       'in_1': ['InL', 'AudioPort'],
                                       'in_2': ['InR', 'AudioPort']},
                            'outputs': {'latency': ['Signal Latency',
                                                    'ControlPort'],
                                        'out': ['Out', 'AudioPort'],
                                        'out_1': ['OutL', 'AudioPort'],
                                        'out_2': ['OutR', 'AudioPort']}},
     'warmth': {'controls': {'blend': ['Tape-Tube Blend', 10, -10, 1.0],
                             'drive': ['Drive', 5.0, 0.1, 1.0]},
