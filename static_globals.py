...
trails_mode_settings = {
    ...
    2 : [
        ...
        ["turntable_stop1", "PULL_THE_PLUG", 0],
        ["vca1", "gain", 0.0],
        ["vca2", "gain", 0.0],
        ["vca3", "gain", 0.0],
        ],
