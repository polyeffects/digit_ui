...
'midi_cc_to_note': {'category': 0,
                     'controls': {'channelf': ['Filter Channel',
                                               ...
                                               16,
                                               'int'],
                                  'key': ['Key (midi-note) to use with fixed-key mode',
                                          48,
                                          0,
                                          127,
                                          'int'],
 ...
 'midi_nodup': {'category': 0,
                'controls': {'channelf': ['Filter Channel', 0, 0, 16, 'int']},
                'description': 'MIDI duplicate blocker. Filter out overlapping note on/off and duplicate messages',
                'inputs': {'midiin': ['MIDI In', 'AtomPort']},
                'long_description': '',
                'outputs': {'midiout': ['MIDI Out', 'AtomPort']},
                'tags': {'utilities', 'midi'}},
 ...
 'midi_tonal_pedal': {'category': 0,
                      ...
                      'description': 'Holds any notes that are currently played when the sustain pedal is pressed for as long as the pedal remains pressed. Releasing the pedal sends Note-Off events. New notes played after presseing the pedal are not affected.',
                      'inputs': {'midiin': ['MIDI In', 'AtomPort']},
                      'long_description': '',
                      'outputs': {'midiout': ['MIDI Out', 'AtomPort']},
                      'tags': {'utilities', 'midi'}},
 ...
 'midi_velocity_scale': {'category': 0,
                         'controls': {'channel': ['Channel', 0, 0, 16, 'int'],
                                      ...
                                      'onoff': ['Note-on Offset',
                                                ...
                                                64.0,
                                                'int']},
                         'description': 'modify note velocity by constant factor and offse',
                         'inputs': {'midiin': ['MIDI In', 'AtomPort']},
                         'long_description': '',
                         'outputs': {'midiout': ['MIDI Out', 'AtomPort']},
                         'tags': {'utilities', 'midi'}},
