...
'midi_cc_to_note': {'category': 0,
 ...
 'midi_delay': {'category': 0,
            'broadcast_ports': {'delayBPM': ['BPM', 120, 1, 320]},
 ...
 'midi_event_blocker': {'category': 0,
                        'controls': {'blkcc': ['Block Control Changes',
                                     ...
                                     'blkcp': ['Block Channel-Pressure',
                                               ...
                                               1,
                                               'bool'],
                                     'blknote': ['Block Notes', 0, 0, 1, 'bool'],
 ...
 'midi_tonal_pedal': {'category': 0,
                      'controls': {'forward_cc': ['Forward CC', 0, 0, 1, 'bool'],
...
'trigger_to_gate': {'category': 0,
            'broadcast_ports': {'tempo': ['tempo', 120, 1, 320]},
                     ...
                     'description': 'Takes in a trigger and outputs a gate with a length related to the tempo',
                     'inputs': {'gate_length_cv': ['Gate Length CV', 'CVPort'],
                                'tempo': ['Tempo', 'ControlPort'],
                                'trigger': ['trigger', 'CVPort']},
                     'long_description': 'The gate length is how much of a bar is taken up assuming tempo is quarter notes',
...
'clock_divider': {'category': 0,
                   ...
                   'long_description': 'useful for dividing down a eurorack style clock.',
...
'strum': {'category': 0,
           ...
           'inputs': {},
           'long_description': 'choose chords and then strum the lines to get octaves of a chord',
           'outputs': {'gate_out': ['Gate', 'CVPort'],
                       'midi_out': ['MIDI Out', 'AtomPort'],
                       'v_oct_out': ['v_oct_out', 'CVPort']},
           'tags': {'controls'}},
# 'amp_rtneural': {'category': 0,
#                   'controls': {'ANTIALIASING': ['ANTIALIASING',
#                                                 66.216,
#                                                 0,
#                                                 100.0],
#                                'BASS': ['BASS', 0, -8.0, 8],
#                                'BFREQ': ['BFREQ', 305.0, 75.0, 600.0],
#                                'DEPTH': ['DEPTH', 0, -8.0, 8],
#                                'EQBYPASS': ['EQBYPASS', 0, 0, 1],
#                                'EQPOS': ['EQPOS', 0, 0, 1],
#                                'MASTER': ['OUTPUT', 0, -15.0, 15],
#                                'MFREQ': ['MFREQ', 750.0, 150.0, 5000.0],
#                                'MID': ['MID', 0, -8.0, 8],
#                                'MIDQ': ['MIDQ', 0.707, 0.2, 5.0],
#                                'MTYPE': ['MTYPE', 0, 0, 1],
#                                'NETBYPASS': ['NETBYPASS', 0, 0, 1],
#                                'PARAM1': ['PARAM1', 0, 0, 1.0],
#                                'PARAM2': ['PARAM2', 0, 0, 1.0],
#                                'PREGAIN': ['INPUT', 0, -12.0, 12.0],
#                                'PRESENCE': ['PRESENCE', 0, -8.0, 8],
#                                'TFREQ': ['TFREQ', 2000.0, 1000.0, 4000.0],
#                                'TREBLE': ['TREBLE', 0, -8.0, 8],
#                                'ir': ['/audio/amp_json/deer ink studios/tw40_british_lead_deerinkstudios.json', 0, 0, 1],
#                                },
#                   'description': 'Amp Model Player, allowing it to load models of AI trained music gear',
#                   'inputs': { 'IN': ['IN', 'AudioPort']},
#                   'long_description': 'Using RTNeural and AIDA-DSP code.',
#                   'outputs': {'OUT': ['OUT', 'AudioPort']},
#                   'tags': {'effect', 'amps'}},
'amp_nam': {'category': 0,
